                              ...
                              <div class='row'>
                                 <div class='col-xs-12'>
                                    ...
                                    <div class='col-xs-4'>
                                       ...
                                       <p><span class='fontnumb'><? echo ''.$val['label'].'';?></span></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class='row'>
                                 <div class='col-xs-12'>
                                    <div class='col-xs-3'>
                                       ...
                                       <p><span class='fontnumb'><i class='dollar'>$</i><span class='spincrement'><? echo ''.number_format($data->{$val['alias']}).'' ?></span></span></p>
                                    </div>
                                    <div class='col-xs-3'>
                                       <p><small>Банковский счёт</small></p>
                                       <p><span class='fontnumb'><i class='dollar'>$</i><span class='spincrement'><? echo ''.number_format($data->{$val['alias']}).'' ?></span></p>
                                    </div>
                                    <div class='col-xs-3'>
                              ...
                              <div class='row'>
                                 <div class='col-xs-12'>
                                    ...
                                    <div class='col-xs-6'>
                                       ...
                                       <p><span class='fontnumb'><span class='spincrement'><? echo ''.$names[0]['names'][$data->{$val['alias']}].' (ранг: '.$data->{$field['rang']['alias']}.')' ?></span></p>
                                    </div>
                                    <br>
                                    <div class='col-xs-6'>
