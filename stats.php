...
class QueryServerException extends Exception
{
  ...
  define('SVRNAME', 'ManHattan Role Play');// the name of your server
  define('OWNER', 'Jacques_Anthony'); //server owner name
  define('SVRIP', '185.74.4.111:7777'); //Your server's IP.
  define('SVRSLOGAN', 'Играй вместе с нами!!!'); //Your server's slogan

  $serverIP = "185.74.4.111"; // Add in your server IP. DO NOT ADD THE PORT HERE, ADD IT BELOW!
...
{
    header("Location: statistics/error.php"); // Redirects to an error page if the server is offline. Change this according to your site domain name. You can customize the error page by opening 'error.php'
}
